...
const ServiceDiv = ({index, title, icon}) => {
  return (
    // console.log(icon)
  ...
  return (
    <>
      ...
      className="mt-4 text-secondary text-[17px] leading-[30px]">
        ...
        I diligently follow the Software Development Life Cycle (SDLC) to deliver innovative solutions that drive user 
        satisfaction and business success. Let's work together to bring your ideas to life!
      </motion.p>

      <div className="mt-20 flex flex-wrap gap-10">
        {services.map((services, index) => (
          <ServiceDiv key={services.title} index={index} {...services}/>
        ))}
      </div>
    </>
  )
